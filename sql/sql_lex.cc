...
bool Lex_input_stream::consume_optimizer_hints(YYSTYPE *yylval)
{
      ...
      yyPeekn(whitespace + 2) == '+')
  {
    ...
    else
    {
      ...
      yySkipn(hint_scanner.get_ptr() - get_ptr());
...
int Lex_input_stream::find_keyword(YYSTYPE *yylval, // OLEGS: may be temporary
                                                          ...
                                                          uint length) /*const*/
{
  ...
  */
  ...
  int tokval= find_keyword(nullptr/*OLEGS:*/, str, length, true);
  if (!tokval)
    return 0;
                                        ...
                                        Ident_mode mode)
{
  ...
  case GENERAL_KEYWORD_OR_FUNC_LPAREN:
    ...
    */
    if ((tokval= find_keyword(nullptr /*OLEGS*/, str, length, last_char == '(')))
    {
      yyUnget();                         // Put back 'c'
